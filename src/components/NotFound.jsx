      ...
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
        <div className="w-full flex items-center justify-center">
          <svg
            ...
            viewBox="0 0 600 400"
            className="w-64 h-48 md:w-80 md:h-64"
            aria-hidden
          >
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="flex justify-center mt-6">
            <button
              onClick={() => navigate(-1)}
              className="inline-flex items-center justify-center px-5 py-3 rounded-lg border border-gray-200 bg-white text-gray-800 text-sm font-medium shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Orqaga
            </button>
          </div>
